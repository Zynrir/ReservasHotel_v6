...
public class RegimenTest {
    ...
    void objectosValidosRegimen() {
        ...
        assertEquals("ALOJAMIENTO_DESAYUNO", Regimen.ALOJAMIENTO_CON_DESAYUNO.name(), NOMBRE_NO_VALIDO);
    ...
    void incrementoPrecioValidos() {
        ...
        assertEquals(15, Regimen.ALOJAMIENTO_CON_DESAYUNO.getIncrementoPrecio(), INCREMENTO_PRECIO_NO_VALIDO);
